# This was brought to you by Rapptz on github.
# You can find it here: https://github.com/Rapptz/RoboDanny/blob/master/cogs/utils/checks.py
from discord.ext import commands
import discord.utils

def is_owner_check(message):
    return message.author.id == '129819240654962688'
